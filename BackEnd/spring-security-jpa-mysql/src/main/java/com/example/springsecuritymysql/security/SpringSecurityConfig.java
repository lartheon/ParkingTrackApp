...
//                .disable()
                ...
                .antMatchers(HttpMethod.GET,APP_API+EMPLOYEES_URL+"/**").hasAnyRole("USER","ADMIN")
                .antMatchers(HttpMethod.POST,APP_API+EMPLOYEES_URL+"/**").hasAnyRole("USER","ADMIN")
                .antMatchers(HttpMethod.PUT,APP_API+EMPLOYEES_URL+"/**").hasAnyRole("USER","ADMIN")
                .antMatchers(HttpMethod.DELETE,APP_API+EMPLOYEES_URL+"/**").hasRole("ADMIN")
                .anyRequest().authenticated()
                .and()
                .logout().logoutUrl(APP_API+SIGN_OUT_URL).permitAll().logoutSuccessUrl(APP_API+LOGIN_URL).permitAll()
                .and()
                .authorizeRequests().antMatchers(HttpMethod.PUT,APP_API+VEHICLES_URL+"/**").permitAll()
                .and()
